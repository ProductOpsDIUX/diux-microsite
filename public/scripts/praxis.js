...
(function () {
  ...
  const SEARCH_INDEX = [
    // Articles
    { type: 'Article', title: 'Designing trust into autonomous mission systems', meta: 'AI · Trust · 12 min', url: '/article' },
    { type: 'Article', title: 'The new operator: from joystick to dialogue', meta: 'UX · Interaction · 8 min', url: '/article' },
    { type: 'Article', title: 'Sensor fusion as a design material', meta: 'AI · Data · 14 min', url: '/article' },
    { type: 'Article', title: 'Cognitive load on the modern bridge', meta: 'Research · 10 min', url: '/article' },
    { type: 'Article', title: 'A pattern language for command interfaces', meta: 'Systems · 16 min', url: '/article' },
    { type: 'Article', title: 'Why glanceable beats comprehensive', meta: 'UX · Heuristics · 6 min', url: '/article' },
    // Case studies
    { type: 'Case study', title: 'Mission Compose — Joint planning workspace', meta: 'Workspace · 2025', url: '/case-study' },
    { type: 'Case study', title: 'Aegis Console — Multi-domain awareness', meta: 'Operator UI · 2025', url: '/case-study' },
    { type: 'Case study', title: 'Forge — AI-assisted document workflows', meta: 'AI Tools · 2024', url: '/case-study' },
    { type: 'Case study', title: 'Beacon — Edge sensor configurator', meta: 'Field tools · 2024', url: '/case-study' },
    { type: 'Case study', title: 'Sentry — Threat triage for analysts', meta: 'Intel · 2024', url: '/case-study' },
    { type: 'Case study', title: 'Atlas — Roadmap intelligence platform', meta: 'Strategy · 2025', url: '/case-study' },
    // Team
    { type: 'Team', title: 'Maya Okafor — Head of Design Innovation', meta: 'Leadership', url: '/team' },
    { type: 'Team', title: 'Jonas Lindqvist — Principal AI/UX Researcher', meta: 'Research', url: '/team' },
    { type: 'Team', title: 'Aria Venkatesan — Staff Interaction Designer', meta: 'Design', url: '/team' },
    // Pages
    { type: 'Page', title: 'Capabilities — UX, AI, Innovation, Transformation', meta: 'About', url: '/#capabilities' },
    { type: 'Page', title: 'Publications & resources', meta: 'Library', url: '/#publications' },
    { type: 'Page', title: 'Hackathons & events', meta: 'Programs', url: '/#events' }
  ];
